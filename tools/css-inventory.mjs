...
const OURS = /^(ww-|vs-|vss-|acard|home-|lp-|au-|exp-|st-|dg-|mem-|memo|teams-|bs-|tc-|rq-|ws-|pcal|login-modal|auth-|mod-|tag|icon-btn|pub-toggle|heart|t$|s$|is-|has-|open$|arcade|tvs|skin-|hl-|f-|btn-join|race-|qlw?|el-|item-|list-)/;
