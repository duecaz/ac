...
// basura si supera su baseline. B4 · cableado · B1 · declaraciones · B2 · contrato · B3 · vista↔plantilla (2026-09-02).
if (!soloListas) {
  for (const b of ['tools/costuras-cableado.mjs', 'tools/costuras-declaraciones.mjs', 'tools/costuras-contrato.mjs', 'tools/costuras-plantilla-en-vista.mjs']) {
