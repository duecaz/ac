...
const PASOS = [
  ...
  { id: 'tipos',   cmd: 'tools/typecheck.mjs',  que: 'TypeScript como verificador del JS (checkJs + strict, sin .ts ni build): ni una propiedad inexistente, ni un null sin comprobar, ni dos adaptadores con distinta firma', rapido: true },
  ...
  { id: 'puertas', cmd: 'tools/editor-puertas.mjs', que: 'todas tienen puerta visible para añadir y dicen qué hacer con la actividad vacía' },
  { id: 'buscar',  cmd: 'tools/find-smoke.mjs',   que: 'el viaje buscar/crear (portada → biblioteca → elegir plantilla → EDITAR → guardar → buscarla)' },
  { id: 'editar',  cmd: 'tools/edit-audit.mjs',   que: 'teclear en los editores, pestaña por pestaña: ni se pierde la respuesta correcta ni el foco ni la pestaña' },
