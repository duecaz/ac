...
import { isVowel, applyTilde, scoreMarksPerHit, wordAtPos, markPartsFor, markValueParts, passageLabel } from './textMarks.js';
 ...
 */
function renderTextCorrectionRound(root, payload, { kind = 'tilde', onSubmit, chips = {}, reloj = false, progreso = null } = {}) {
