...
| **3** | 🟡 **EN MARCHA (v1.51.383)** — cubrir las mecánicas en pizarra: la matriz ya JUEGA una ronda real en VS (toque → la app juzga → el lado avanza) en 7 de 8 plantillas jugables; falta el driver de arrastre de Sopa de Letras, y extender la jugada a Individual/Equipos | §1 ("lo habitual") + medición 0,47 y 0,17 | Es donde se juega de verdad |
