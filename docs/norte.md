...
| **3** | ✅ **HECHO (v1.51.384)** — la matriz JUEGA la ronda con gesto real en los TRES modos de pizarra (22/23; 6 mecánicas compartidas en `tools/helpers/roundDrivers.mjs`). Encontró una deuda real: Equipos+Sopa pierde el hallazgo (declarada, no tapada) | §1 ("lo habitual") + medición 0,47 y 0,17 | Es donde se juega de verdad. Sin driver aún: las mecánicas de arrastre libre de Individual (Emparejar · Memoria · Diagrama · Crucigrama · Ruleta · Abre Cajas) |
