...
| **`handoff-rendimiento-animaciones.md`** | Por qué la soga del VS y el podio se ralentizan en la pizarra 4K (SVG de 153 trazados re-dibujado cada cuadro, `ww-lite` que no se abre en un RK3588, sombras y blur a DPR 3) y el plan en seis fases: medir en el aparato, `ww-lite` por síntoma, la soga pre-rasterizada, el podio barato, la regla como test, la sonda con DPR |
