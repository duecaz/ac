...
| **`handoff-editor-general.md`** | El editor como pieza general: márgenes del panel, «+ Añadir» en las 13, imagen↔pines, contenido de ejemplo y buscador de imágenes (decidido 2026-08-13, sin ejecutar) |
