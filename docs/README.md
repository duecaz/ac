...
| **Qué produce llevar el contenido de una plantilla a otra** (todas las conversiones, medidas) | `conversiones.md` (GENERADO: `node tools/conversiones.mjs --md`) |
...
| **`handoff-arquitectura-actividades.md`** | El rediseño de la FRONTERA entre una actividad y la plataforma (pedido 2026-09-13, al ver que retirar una actividad tocó 92 ficheros): las tres cifras del diagnóstico (46 puertas de `core/`, 2.100 líneas de «familia» disfrazadas de núcleo, cuatro listas por actividad en el anfitrión), cómo lo resuelven H5P · Moodle · VS Code · Obsidian, y cinco decisiones — una puerta con versión · el manifiesto declara lo que hoy son listas · la familia es una unidad · un modelo una forma · descubrir por convención |
...
| **`handoff-rendimiento-animaciones.md`** | Por qué la soga del VS y el podio se ralentizan en la pizarra 4K (SVG de 153 trazados re-dibujado cada cuadro, `ww-lite` que no se abre en un RK3588, sombras y blur a DPR 3) y el plan en seis fases con UNA decisión: las mismas animaciones en todas las pantallas (solo `transform`/`opacity` y lienzos con tope, como Wordwall) — medir en el aparato, la soga en lienzo, el podio barato, la regla como test, retirar `ww-lite`, la sonda con DPR 3 |
