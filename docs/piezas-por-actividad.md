...
| **Tildes** (`tildes`) | `16/10` | — | `header «Lápiz» (sin nombre)` 100%×7% → **barra**<br>`div (sin nombre)` 100%×1% → **barra**<br>`tc-body` 100%×93% → **escenario** | `header «Lápiz» (sin nombre)` 100%×5% → **barra**<br>`div (sin nombre)` 100%×0% → **barra**<br>`tc-body` 100%×95% → **escenario** |
| **Comas** (`comas`) | `16/10` | — | `header «Lápiz» (sin nombre)` 100%×7% → **barra**<br>`div (sin nombre)` 100%×1% → **barra**<br>`tc-body` 100%×93% → **escenario** | `header «Lápiz» (sin nombre)` 100%×5% → **barra**<br>`div (sin nombre)` 100%×0% → **barra**<br>`tc-body` 100%×95% → **escenario** |
...
| **Rompecabezas** (`puzzle`) | `4/3` | — | `pu-board` 28%×46% → **—**<br>`pu-pieces` 78%×52% → **escenario** | `pu-board` 60%×34% → **—**<br>`pu-pieces` 100%×56% → **escenario** |
...
- **Abre Cajas** → `div «Toca una caja para» (sin nombre)`
