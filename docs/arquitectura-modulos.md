...
| **jugar en pizarra** | **lo habitual** — solo · VS · equipos, sin móviles | 12 · 2772 | 12 · 1262 | 0.46 |
...
| **infra/común** | todo lo anterior | 142 · 17265 | 58 · 6999 | 0.41 |
...
| **core** | `core/textCorrectionRound.js` (455) · `core/normsCheck.js` (392) · `core/aiContent.js` (385) · `core/skins.js` (367) · `core/selftest.js` (345) |
