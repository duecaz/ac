...
| **infra/común** | todo lo anterior | 131 · 14258 | 50 · 5602 | 0.39 |
...
| **core** | `core/textCorrectionRound.js` (386) · `core/skins.js` (355) · `core/selftest.js` (345) · `core/auth.js` (330) · `core/normsCheck.js` (325) |
