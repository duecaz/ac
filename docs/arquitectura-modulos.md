...
| **jugar en pizarra** | **lo habitual** — solo · VS · equipos, sin móviles | 15 · 3812 | 13 · 1811 | 0.48 |
...
| **infra/común** | todo lo anterior | 195 · 27005 | 79 · 11484 | 0.43 |
...
| **core** | `core/soloPlayer.js` (654) · `core/auth.js` (490) · `core/vsAnimations.js` (444) · `core/normsCheck.js` (415) · `core/aiContent.js` (413) |
