...
>
> **269 módulos · 1046 imports internos.**
...
|---|---|---|---|---|
| **buscar/crear** | **siempre** — toda clase empieza aquí | 14 · 1801 | 7 · 859 | 0.48 |
| **jugar en pizarra** | **lo habitual** — solo · VS · equipos, sin móviles | 12 · 2813 | 12 · 1370 | 0.49 |
...
| **plantillas (mecánicas)** | siempre (es el contenido jugado) | 71 · 5868 | 13 · 1778 | 0.30 |
| **infra/común** | todo lo anterior | 143 · 17431 | 62 · 7541 | 0.43 |
...
| **vistas** | `views/adminView.js` (1345) · `views/hostLive.js` (1110) · `views/studentLive.js` (922) · `views/playerView.js` (535) · `views/vsView.js` (527) |
...
| **core** | `core/textCorrectionRound.js` (455) · `core/normsCheck.js` (450) · `core/skins.js` (395) · `core/aiContent.js` (385) · `core/selftest.js` (345) |
