...
>
> **370 módulos · 1482 imports internos.**
...
| **jugar en pizarra** | **lo habitual** — solo · VS · equipos, sin móviles | 15 · 3769 | 13 · 1811 | 0.48 |
...
| **plantillas (mecánicas)** | siempre (es el contenido jugado) | 94 · 8504 | 13 · 1945 | 0.23 |
| **infra/común** | todo lo anterior | 195 · 26915 | 79 · 11145 | 0.41 |
...
|---|---|
| **arranque** | `pb_hooks/aulareto-lib.js` (364) · `pb_hooks/aulareto.pb.js` (354) · `qa/hoja.js` (337) · `main.teacher.js` (166) · `main.embed.js` (69) |
...
| **core** | `core/soloPlayer.js` (611) · `core/auth.js` (490) · `core/vsAnimations.js` (444) · `core/normsCheck.js` (415) · `core/aiContent.js` (413) |
