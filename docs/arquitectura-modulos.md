...
>
> **257 módulos · 978 imports internos.**
...
| **infra/común** | todo lo anterior | 131 · 14363 | 50 · 5758 | 0.40 |
...
| **core** | `core/textCorrectionRound.js` (434) · `core/skins.js` (355) · `core/selftest.js` (345) · `core/auth.js` (330) · `core/normsCheck.js` (325) |
...
| `core/textCorrectionRound.js` | 434 | 5 |
