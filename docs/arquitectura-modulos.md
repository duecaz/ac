...
>
> **269 módulos · 1040 imports internos.**
...
| **plantillas (mecánicas)** | siempre (es el contenido jugado) | 71 · 5839 | 13 · 1778 | 0.30 |
| **infra/común** | todo lo anterior | 143 · 17388 | 60 · 7358 | 0.42 |
...
| **core** | `core/textCorrectionRound.js` (455) · `core/normsCheck.js` (439) · `core/aiContent.js` (385) · `core/skins.js` (381) · `core/selftest.js` (345) |
