...
|---|---|---|---|---|
| **buscar/crear** | **siempre** — toda clase empieza aquí | 14 · 1815 | 7 · 859 | 0.47 |
| **jugar en pizarra** | **lo habitual** — solo · VS · equipos, sin móviles | 12 · 2834 | 12 · 1378 | 0.49 |
...
| **infra/común** | todo lo anterior | 143 · 17431 | 62 · 7552 | 0.43 |
...
| **vistas** | `views/adminView.js` (1345) · `views/hostLive.js` (1110) · `views/studentLive.js` (922) · `views/playerView.js` (556) · `views/vsView.js` (527) |
