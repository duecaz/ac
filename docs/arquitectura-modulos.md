...
| **infra/común** | todo lo anterior | 131 · 14261 | 50 · 5602 | 0.39 |
...
| **core** | `core/textCorrectionRound.js` (389) · `core/skins.js` (355) · `core/selftest.js` (345) · `core/auth.js` (330) · `core/normsCheck.js` (325) |
