...
| **jugar en pizarra** | **lo habitual** — solo · VS · equipos, sin móviles | 15 · 3737 | 13 · 1724 | 0.46 |
...
| **core** | `core/soloPlayer.js` (542) · `core/vsAnimations.js` (503) · `core/auth.js` (490) · `core/aiContent.js` (413) · `core/selftest.js` (378) |
