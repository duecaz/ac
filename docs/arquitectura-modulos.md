...
| **jugar en pizarra** | **lo habitual** — solo · VS · equipos, sin móviles | 15 · 3658 | 13 · 1724 | 0.47 |
...
| **core** | `core/soloPlayer.js` (542) · `core/auth.js` (490) · `core/vsAnimations.js` (424) · `core/aiContent.js` (413) · `core/selftest.js` (378) |
