...
| **infra/común** | todo lo anterior | 143 · 18043 | 64 · 7915 | 0.44 |
...
| **core** | `core/textCorrectionRound.js` (753) · `core/normsCheck.js` (450) · `core/skins.js` (395) · `core/aiContent.js` (385) · `core/selftest.js` (345) |
...
| `core/textCorrectionRound.js` | 753 | 5 |
