...
| **infra/común** | todo lo anterior | 131 · 14346 | 50 · 5740 | 0.40 |
...
| **core** | `core/textCorrectionRound.js` (417) · `core/skins.js` (355) · `core/selftest.js` (345) · `core/auth.js` (330) · `core/normsCheck.js` (325) |
...
| `core/textCorrectionRound.js` | 417 | 5 |
