...
| **plantillas (mecánicas)** | siempre (es el contenido jugado) | 71 · 5873 | 13 · 1778 | 0.30 |
| **infra/común** | todo lo anterior | 143 · 17935 | 64 · 7897 | 0.44 |
...
| **core** | `core/textCorrectionRound.js` (682) · `core/normsCheck.js` (450) · `core/skins.js` (395) · `core/aiContent.js` (385) · `core/selftest.js` (345) |
...
| `core/textCorrectionRound.js` | 682 | 5 |
